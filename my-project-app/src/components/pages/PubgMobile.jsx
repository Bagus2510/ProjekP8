    ...
    const categories = [
        {
            name: 'UC',
            items: [
                { id: 1, name: '65 UC', price: 'Rp. 15.000' },
                { id: 2, name: '320 UC', price: 'Rp. 79.000' },
                { id: 3, name: '665 UC', price: 'Rp. 155.000' },
                { id: 4, name: '1850 UC', price: 'Rp. 390.000' },
                { id: 5, name: '3900 UC', price: 'Rp. 780.000' },
                { id: 6, name: '8000 UC', price: 'Rp. 1.550.000' }
            ]
        },
    ];
            ...
            <div className="bg-purple-700 text-white pt-28 pb-20">
                <div className="container mx-auto max-w-lg bg-white text-black rounded-lg p-8 shadow-lg">
                    ...
                    <p className="text-sm text-gray-600 text-justify">
                        To find your ID, click on the character icon. The User ID is listed above your character icon. Example: "5362266446".
                    </p>
                </div>
                <div className="container mx-auto max-w-lg bg-white text-black rounded-lg p-8 shadow-lg mt-8">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex space-x-4">
                            <button
                                className={`p-4 border-2 rounded-md ${selectedCategory === 'UC' ? 'bg-purple-500 text-white' : 'border-purple-700'}`}
