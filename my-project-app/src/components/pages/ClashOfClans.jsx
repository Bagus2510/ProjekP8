    ...
    const categories = [
        {
            name: 'Gems',
            items: [
                { id: 1, name: '90 Gems', price: 'Rp. 14.400' },
                { id: 2, name: '560 Gems', price: 'Rp. 71.200' },
                { id: 3, name: '1330 Gems', price: 'Rp. 143.000' },
                { id: 4, name: '2760 Gems', price: 'Rp. 296.000' },
                { id: 5, name: '7160 Gems', price: 'Rp. 720.000' },
                { id: 6, name: '15430 Gems', price: 'Rp. 1.445.000' },
                { id: 7, name: 'Gold Pass', price: 'Rp. 100.000' },
            ],
        },
    ];
            ...
            <div className="bg-purple-700 text-white pt-28 pb-20">
                <div className="container mx-auto max-w-lg bg-white text-black rounded-lg p-8 shadow-lg">
                    ...
                    <p className="text-sm text-gray-600 text-justify">
                        Press the 'Profile' button in the top left corner of your game screen. View your Player Tag just below your game name.
                    </p>
                    <p className="text-sm text-yellow-600 text-justify">
                        Please double-check your Player Tag and make sure it is connected to your Supercell ID before making any purchases.
                    </p>
                </div>
                <div className="container mx-auto max-w-lg bg-white text-black rounded-lg p-8 shadow-lg mt-8">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex space-x-4">
                            <button
                                className={`p-4 border-2 rounded-md ${selectedCategory === 'Gems' ? 'bg-purple-500 text-white' : 'border-purple-700'}`}
