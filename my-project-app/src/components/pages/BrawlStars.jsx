    ...
    const categories = [
        {
            name: 'Gems',
            items: [
                { id: 1, name: '32 Gems', price: 'Rp. 28.000' },
                { id: 2, name: '81 Gems', price: 'Rp. 70.000' },
                { id: 3, name: '180 Gems', price: 'Rp. 144.000' },
                { id: 4, name: '370 Gems', price: 'Rp. 297.500' },
                { id: 5, name: '960 Gems', price: 'Rp. 718.000' },
                { id: 6, name: '2100 Gems', price: 'Rp. 1.440.000' },
                { id: 7, name: 'Brawl Pass Plus', price: 'Rp. 143.000' },
            ],
        },
    ];
            ...
            <div className="bg-purple-700 text-white pt-28 pb-20">
                <div className="container mx-auto max-w-lg bg-white text-black rounded-lg p-8 shadow-lg">
                    ...
                    <p className="text-sm text-gray-600 text-justify">
                        1. Tap on the 'Profile' icon in the top left corner of your game screen.
                    </p>
                    <p className="text-sm text-gray-600 text-justify">
                        2. Look at your Player Tag just below your player icon (#).
                    </p>
                </div>
