...
function FreeFire() {
    ...
    const categories = [
        {
            name: 'Diamonds',
            items: [
                { id: 1, name: '7 Diamonds', price: 'Rp. 1.000' },
                { id: 2, name: '14 Diamonds', price: 'Rp. 2.000' },
                { id: 3, name: '51 Diamonds', price: 'Rp. 7.200' },
                { id: 4, name: '71 Diamonds', price: 'Rp. 9.000' },
                { id: 5, name: '141 Diamonds', price: 'Rp. 18.000' },
                { id: 6, name: '358 Diamonds', price: 'Rp. 45.000' },
                { id: 7, name: '724 Diamonds', price: 'Rp. 90.000' },
                { id: 8, name: '1459 Diamonds', price: 'Rp. 181.000' },
                { id: 9, name: '2181 Diamonds', price: 'Rp. 270.000' },
                { id: 10, name: '3642 Diamonds', price: 'Rp. 450.000' },
                { id: 11, name: '7293 Diamonds', price: 'Rp. 900.000' },
                { id: 12, name: '36540 Diamonds', price: 'Rp. 4.504.000' },
                { id: 13, name: '73150 Diamonds', price: 'Rp. 9.009.000' }
            ]
        },
    ];
    ...
    const handleItemClick = (itemId) => {
        setSelectedItem(selectedItem === itemId ? null : itemId); // Toggle item selection
    };
    ...
    const handlePaymentClick = (paymentId) => {
        setSelectedPayment(selectedPayment === paymentId ? null : paymentId); // Toggle payment method selection
    };
            ...
            <div className="bg-purple-700 text-white pt-28 pb-20">
                <div className="container mx-auto max-w-lg bg-white text-black rounded-lg p-8 shadow-lg">
                    ...
                    <p className="text-sm text-gray-600 text-justify">
                        To find your ID, click on the character icon. The User ID is listed below your character name. Example: "5362266446".
                    </p>
                </div>
                <div className="container mx-auto max-w-lg bg-white text-black rounded-lg p-8 shadow-lg mt-8">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex space-x-4">
                            <button
                                className={`p-4 border-2 rounded-md ${selectedCategory === 'Diamonds' ? 'bg-purple-500 text-white' : 'border-purple-700'}`}
                                onClick={() => handleCategoryClick('Diamonds')}
                            >
                                Diamonds
                            </button>
                        </div>
