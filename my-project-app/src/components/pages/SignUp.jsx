    ...
    return (
        <>
            ...
            <div className="bg-purple-700 min-h-screen text-white p-4 pt-20">
                <h2 className="text-5xl font-bold mb-4 text-center pt-16">Sign Up</h2>
                <div className="max-w-md mx-auto bg-white text-black rounded-lg p-8 mb-14">
                    <form>
                        <div className="mb-4">
                        ...
                        <div className="mb-4">
                            ...
                            <input type="email" id="email" className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-300" required />
                        </div>
                        <div className="mb-4">
                        ...
                        <div className="mb-4">
                            ...
                            <input type="password" id="confirmPassword" className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-300" required />
                        </div>
                        <div className="flex items-center justify-between mb-4">
                            <SignupButton><a href="#">Sign Up</a></SignupButton>
                        </div>
                        <div className="text-center">
                            <p>Already have an account? <a href={links.login} className="text-purple-900 hover:underline cursor-pointer">Login</a></p>
                        </div>
                    </form>
                </div>
            </div>
